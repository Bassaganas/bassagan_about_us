        ...
        <footer className="bg-gray-100 dark:bg-gray-800 py-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-lg font-bold mb-4">Paula Bassagañas Òdena</h3>
                        <p className="text-gray-600 dark:text-gray-300 mb-2">IT Architect</p>
                        <p className="text-gray-600 dark:text-gray-300">Test Automation & Pharmaceutical</p>
                    </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-500 dark:text-gray-400">
                    © {currentYear} Paula Bassagañas Òdena. All rights reserved.
                </div>
            </div>
        </footer>
    );
