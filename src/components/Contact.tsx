                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-6">
                                Feel free to reach out if you have any questions about my work, are interested in collaboration,
                                or want to discuss potential opportunities.
                            </p>
                            ...
                            <div className="mb-6">
                                <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Connect</h4>
                        ...
                        <div>
                            ...
                            <form className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition shadow-md w-full"
                                >
                                    Send Message
                                </button>
                            </form>
